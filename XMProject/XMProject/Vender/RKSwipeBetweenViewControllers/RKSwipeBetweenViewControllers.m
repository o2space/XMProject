...
@synthesize pageSelected;
@synthesize pageUnselected;
...
-(void)initNavBar{
    //nav view
    self.navBarView=[[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, 64)];
    self.navBarView.backgroundColor=[UIColor whiteColor];
    [self.view addSubview:self.navBarView];
    //nav bg
    UIImageView *navbg=[[UIImageView alloc] initWithFrame:self.navBarView.frame];
    navbg.backgroundColor=[UIColor clearColor];
    navbg.image=[UIImage resizedImage:@"nav_bar_bg"];
    [self.navBarView addSubview:navbg];
}
...
-(void)setupSegmentButtons {
    ...
    navigationView = [[UIView alloc]initWithFrame:CGRectMake(X_BUFFER,20,self.view.frame.size.width - 2*X_BUFFER,44)];
    ...
    _buttonContainer.showsHorizontalScrollIndicator=NO;
    _buttonContainer.showsVerticalScrollIndicator=NO;
    ...
    for (int i = 0; i<numControllers; i++) {
        ...
        button.titleLabel.textColor =[UIColor colorWithRed:29/255.0 green:29/255.0 blue:38/255.0 alpha:1.0];
        ...
        [button setTitleColor:[UIColor colorWithRed:29/255.0 green:29/255.0 blue:38/255.0 alpha:1.0] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:[buttonImages objectAtIndex:i]] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:[buttonImages objectAtIndex:i]] forState:UIControlStateHighlighted];
    ...
    _pageControl = ({
        ...
        //pageControl.currentPageIndicatorImage = [UIImage imageNamed:@"nav_page_selected_red"];
        ...
        for (int i = 0; i<numControllers; i++) {
            if (pageSelected&&[pageSelected count]>=i+1) {
                [pageControl setImage:[UIImage imageNamed:[pageUnselected objectAtIndex:i]] forPage:i];
            }else{
                [pageControl setImage:[UIImage imageNamed:@"nav_page_unselected"] forPage:i];
            }
            if (pageUnselected&&[pageUnselected count]>=i+1) {
                [pageControl setCurrentImage:[UIImage imageNamed:[pageSelected objectAtIndex:i]] forPage:i];
            }else{
                [pageControl setCurrentImage:[UIImage imageNamed:@"nav_page_selected"] forPage:i];
            }
        }
    ...
    [self.navBarView addSubview:navigationView];
}
